...
export default function QuizQuestionPage({ params }: { params: Promise<{ step: string }> }) {
  ...
  return (
    <div className="bg-[#F9F5F0] min-h-screen flex flex-col">
      ...
      {/* pt etwas groesser als die reine Header-Hoehe: gibt dem
          'Schritt X / Y'-Text Luft zur Progress-Bar des Headers. */}
      <main className="flex-1 flex flex-col pt-24 md:pt-32 pb-32">
