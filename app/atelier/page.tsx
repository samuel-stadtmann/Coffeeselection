  ...
  return (
    <div className="min-h-screen bg-[#fdf9f4]">
      ...
      <section className="max-w-5xl mx-auto px-6 pb-12">
        <Link href="/atelier/die-perfekte-extraktion" className="group block relative rounded-2xl overflow-hidden">
      ...
      <section className="max-w-5xl mx-auto px-6 pb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {categories.map((cat) => (
            <Link
              key={cat.title}
              href={`/atelier/${cat.title.toLowerCase().replace(/[^a-z0-9]+/g, "-")}`}
