...
/**
 * Geteilte Coffee-Card-Buttons: "Einmal kaufen" + "Abo".
 * Eingesetzt auf /coffee (Shop), /recommendation/alternatives,
 * /taste-types/[slug]. Default: 250g, qty 1, Abo-Intervall 2 Wochen
 * — User kann im Cart weiter anpassen.
 */
export default function CoffeeCardCartButtons(props: Props) {
